...
const Admin = () => {
  ...
  const handleDownloadBill = (bill) => {
    ...
    const projectDetails = bill.project ? projects.find(p => p._id === (bill.project._id || bill.project)) : null;
    ...
    <style>
        ...
        .status-badge { display: inline-block; background-color: ${bill.status === 'Paid' ? '#059669' : '#dc2626'} !important; color: #ffffff !important; font-weight: 700; font-size: 9pt; text-transform: uppercase; letter-spacing: 1.5px; padding: 6px 16px; border-radius: 4px; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    <div class="invoice-box">
        ...
        <div class="details-container">
            <div class="billing-block">
                ...
                <p><strong>Name:</strong> ${clientData?.contactPerson || 'N/A'}</p>
                <p><strong>Company:</strong> ${clientData?.clientName || 'N/A'}</p>
                <p><strong>Project:</strong> ${projectDetails?.projectName || clientData?.projectName || 'N/A'}</p>
                <p><strong>Email:</strong> ${clientData?.email || 'N/A'}</p>
                ${clientData?.billingAddress ? `<p><strong>Address:</strong> ${clientData.billingAddress}</p>` : ''}
            </div>
        ...
        <table class="invoice-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: right; font-weight: 600; color: #334155;">₹${(bill.amount || 0).toFixed(2)}</td>
                </tr>
            </tbody>
        </table>
        <div class="summary-wrapper">
            <div class="summary-table">
                <div class="summary-row">
                    ...
                    <span style="font-weight: 600; color: #0f172a;">₹${(bill.amount || 0).toFixed(2)}</span>
                </div>
                <div class="summary-row">
